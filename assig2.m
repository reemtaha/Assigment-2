...
x=T{1:m_60,1:3}; %selected features
xrest=T{1:m_60,4:13};
y=T{1:m_60,14};
...
x1=T{m_60+1:m_60+m_20,1:3}; %selected features
xrest1=T{m_60+1:m_60+m_20, 4:13};
...
n1=length(X1(1,:)); 
 ...
 theta1=theta1-(Alpha/m_20)*X1'*(h1-Y1);
...
m_last=m_60+m_20+1;
x2=T{m_last:end,1:3}; %selected features
xrest2=T{m_last:end, 4:13};
y2=T{m_last:end,14};
