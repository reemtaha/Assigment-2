...
%Second hypothesis of assignment 2 using the next 3 features with the same
...
x=T{1:m_60,4:6}; %selected features
xrest=T{1:m_60,[1:3 7:13]};
y=T{1:m_60,14};
...
x1=T{m_60+1:m_60+m_20,4:6}; %selected features
xrest1=T{m_60+1:m_60+m_20,[1:3 7:13]};
...
m_last=m_60+m_20+1;
x2=T{m_last:end,4:6}; %selected features
xrest2=T{m_last:end,[1:3 7:13]};
y2=T{m_last:end,14};
