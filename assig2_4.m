...
%Fourth hypothesis of assignment 2 using the last 3 features with the same
...
x=T{1:m_60,10:13}; %selected features
xrest=T{1:m_60,1:9};
y=T{1:m_60,14};
...
x1=T{m_60+1:m_60+m_20,10:13}; %selected features
xrest1=T{m_60+1:m_60+m_20,1:9};
...
m_last=m_60+m_20+1;
x2=T{m_last:end,10:13}; %selected features
xrest2=T{m_last:end,1:9};
y2=T{m_last:end,14};
